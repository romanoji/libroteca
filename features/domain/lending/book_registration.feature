Feature: Book registration
  ...
  Scenario: Register a new book copy
    ...
    When I register a book copy of "Larry Niven, Jerry Pournelle" titled "The Mote in God's Eye" with ISBN "9781568650548"
  ...
  Scenario: Register a new book copy without ISBN
    When I register a book copy of "Adam Mickiewicz" titled "Pan Tadeusz"
    Then the book should be registered in library
  ...
  Scenario: Trying to register a new book with ISBN already in use
    ...
    When I register a book copy of "George R.R. Martin" titled "A Dance with Dragons" with ISBN "978-0553801477"
  ...
  Scenario: Trying to register a new book providing ISBN of invalid length
    When I register a book copy of "J.K. Rowling" titled "Harry Potter and the Goblet of Fire" with ISBN "0-7475"
