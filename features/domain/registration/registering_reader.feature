Feature: Registering reader
  ...
  Scenario: Trying to register reader with an email of invalid format
    Given reader wants to register in library
    When I try to register reader by his name "John", surname "Kowalsky", email "john.@mail" and phone "987654321"
  ...
  Scenario: Trying to register reader with a phone of invalid format
    Given reader wants to register in library
    When I try to register reader by his name "John", surname "Kowalsky", email "kowalsky.john@mail.com" and phone "I23A567B9"
