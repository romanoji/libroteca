Feature: Registering reader
  ...
  Remark: Phone number is based on ITU-T E.123 standard

  Scenario: Register a new reader in library
    Given reader wants to register in library
    When I register reader with his name "John", surname "Kowalsky", email "john.kowalsky@mail.com" and phone "123456789"
  ...
  Scenario: Trying to register reader with an email already in use
    ...
    When I try to register reader with his name "John", surname "Kowalsky", email "john.kowalsky@mail.com" and phone "987654321"
  ...
  Scenario: Trying to register reader with a phone already in use
    Given there is reader with email "john.kowalsky@mail.com", name "John", surname "Kowalsky" and phone "123456789"
    When I try to register reader with his name "John", surname "Kowalsky", email "kowalsky.john@mail.com" and phone "123456789"
  ...
  Scenario: Trying to register reader with an email of invalid format
    Given reader wants to register in library
    When I try to register reader with his name "John", surname "Kowalsky", email "jk.@mail" and phone "987654321"
  ...
  Scenario: Trying to register reader with a phone of invalid format
    Given reader wants to register in library
    When I try to register reader with his name "John", surname "Kowalsky", email "john.kowalsky@mail.com" and phone "I23A567B9"
