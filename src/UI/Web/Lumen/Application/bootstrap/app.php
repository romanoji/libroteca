...
$app->singleton(
    ...
    RJozwiak\Libroteca\Lumen\Exceptions\Handler::class
);

$app->singleton(
    Illuminate\Contracts\Console\Kernel::class,
    RJozwiak\Libroteca\Lumen\Console\Kernel::class
);
...
$app->group(['namespace' => 'RJozwiak\Libroteca\Lumen\Http\Controllers'], function ($app) {
